...
@section('content')
    ...
    <section class="position-relative pb-0">
        <div class="gen-register-page-background"
            style="background-image: url('{{ asset('assets/img/background/asset-3.jpeg') }}');">
        </div>
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="text-center">
                        <form id="pms_register-form" action="{{ route('auth.register.post') }}" class="pms-form"
                            method="POST">
                            @csrf
                            <h4>Register</h4>
                            <ul class="pms-form-fields-wrapper pl-0">
                                @if (isset($referral_code) && !empty($referral_code))
                                    <li class="pms-field pms-user-login-field ">
                                        ...
                                        <input id="pms_user_login" name="referral_code" type="text"
                                            value="{{ old('referral_code') ? old('referral_code') : '' }}">
                                    </li>
                                @endif
                                <li class="pms-field pms-user-login-field ">
                                    <label for="pms_user_login">Username </label>
                                    <input id="pms_user_login" name="username" type="text"
                                ...
                                <li class="pms-field pms-user-email-field ">
                                    ...
                                    <input id="pms_user_email" name="email" type="text"
                                ...
                                <li class="pms-field pms-first-name-field ">
                                    ...
                                    <input id="pms_first_name" name="fullname" type="text"
                                ...
                                <li class="pms-field pms-last-name-field ">
                                    ...
                                    <input id="pms_last_name" name="phone_number" type="text"
                                ...
                                <li class="pms-field pms-last-name-field ">
                                    ...
                                    @if ($errors->has('account_type'))
                                        <small>{!! $errors->get('account_type')[0] !!}</small>
                                    @endif
                                </li>
                            ...
                            <br><br>
                            <p><input name="pms_register" type="submit" value="Register"></p>
                        </form>
                    </div>
                </div>
            </div>
