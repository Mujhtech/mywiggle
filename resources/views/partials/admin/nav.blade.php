        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <div class="navigation d-flex">
                <ul class="navbar-nav nav-left">
                    ...
                    @if(config('laravel-mentor.enable_mega_menu'))
                    <li class="nav-item">
                    ...
                    @endif
                    @if(config('laravel-mentor.enable_nav_dropdown_menu'))
                ...
                <ul class="navbar-nav nav-right ml-auto">
                    ...
                    @if(config('laravel-mentor.enabled_search'))
                    <li class="nav-item">
                        ...
                        <div class="search-wrapper">
                            ...
                            <div class="search-content">
                                <form action="{{ route(config('laravel-mentor.search_route')) }}" method="GET">
                                    <div class="form-group">
                                        <i class="ti ti-search magnifier"></i>
                                        <input type="text" name="s" class="form-control autocomplete" placeholder="Search Here" id="autocomplete-ajax" autofocus="autofocus">
                                    </div>
                                </form>
                            </div>
                        </div>
