                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <select name="accttype[]" class="form-control">
                                                        ...
                                                        <option value="smm" @if ('smm' == $user->account_type) selected @endif>
                                                            Social Media Marketer</option>
                                                        <option value="content_creator" @if ('content_creator' == $user->account_type) selected @endif>
